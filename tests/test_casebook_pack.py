"""Regression checks for the granite-dev-generator-plane casebook."""
...
from casebook.harness import assert_expected, granite_dev_generator_plane_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(granite_dev_generator_plane_summary(), assert_expected())
